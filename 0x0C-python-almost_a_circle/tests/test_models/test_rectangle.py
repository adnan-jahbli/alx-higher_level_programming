#!/usr/bin/python3
""" Module for unittesting the rectangle class """
import unittest
...
class TestRectangle(unittest.TestCase):
    ...
    def test_new_rectangle_with_all_attrs(self):
    ...
    def test_incorrect_amount_attrs(self):
        """Test error when 1 argument is passed"""
        with self.assertRaises(TypeError):
            new = Rectangle(1)

    def test_incorrect_amount_attrs_with_no_args(self):
        """Test error when no arguments are passed"""
        with self.assertRaises(TypeError):
            new = Rectangle()

    def test_access_private_attrs_width(self):
        """Test accessing the private attribute 'width'"""
        new = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            new.__width

    def test_access_private_attrs_height(self):
        """Test accessing the private attribute 'height'"""
        new = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            new.__height

    def test_access_private_attrs_x(self):
        """Test accessing the private attribute 'x'"""
        new = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            new.__x

    def test_access_private_attrs_y(self):
        """Test accessing the private attribute 'y'"""
        new = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            new.__y

    def test_invalid_attrs_width(self):
        """Test accessing the private attribute 'width'"""
        with self.assertRaises(TypeError):
            new = Rectangle("2", 2, 2, 2, 2)

    def test_invalid_attrs_height(self):
        """Test passing an invalid value for 'height'"""
        with self.assertRaises(TypeError):
            new = Rectangle(2, "2", 2, 2, 2)

    def test_invalid_attrs_x(self):
        """Test passing an invalid value for 'x'"""
        with self.assertRaises(TypeError):
            new = Rectangle(2, 2, "2", 2, 2)

    def test_invalid_attrs_y(self):
    ...
    def test_create_4(self):
        """ Test the create method """
        dic = {'id': 89, 'width': 1, 'height': 2, 'x': 3}
        r1 = Rectangle.create(**dic)
        self.assertEqual(r1.id, 89)
        self.assertEqual(r1.width, 1)
        self.assertEqual(r1.height, 2)
    ...
    def test_load_from_file(self):
        """ Test the method that loads JSON file """
        load_f = Rectangle.load_from_file()
        self.assertEqual(load_f, [])
