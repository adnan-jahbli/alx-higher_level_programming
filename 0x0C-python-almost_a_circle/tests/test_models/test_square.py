#!/usr/bin/python3
""" This module is for unittesting the Square class """
import unittest
...
class TestSquare(unittest.TestCase):
    """ A test suite for testing the Square class """

    def setUp(self):
        """ This method invoked for each test """
        Base._Base__nb_objects = 0

    def test_new_square1(self):
    ...
    def test_new_square_2(self):
        """ Testing a new square with all attributess """
        new = Square(2, 5, 5, 4)
    ...
    def test_new_squares(self):
        ...
        obj = Square(1, 1)
        obj2 = Square(1, 1)
        self.assertEqual(False, obj is obj2)
        self.assertEqual(False, obj.id == obj2.id)

    def test_if_Base_as_instance(self):
        """ Testing if the Square is a Base instance """
        obj = Square(1)
        self.assertEqual(True, isinstance(obj, Base))

    def test_if_Rectangle_is_instance(self):
        """ Testing if the Square is a Rectangle instance """
        obj = Square(1)
        self.assertEqual(True, isinstance(obj, Rectangle))
    ...
    def test_incorrect_amount_attributes_2(self):
        """ Testing error raised with no arguments passed """
        with self.assertRaises(TypeError):
            obj = Square(1, 1, 1, 1, 1)

    def test_access_private_attributes_1(self):
        """ Trying to access a private attr """
        obj = Square(1)
    ...
    def test_access_private_attributes_3(self):
        """ Trying to access to a private attr """
        obj = Square(1)
        with self.assertRaises(AttributeError):
            obj.__x

    def test_access_private_attributes_4(self):
        """ Trying to access to a private attr """
        obj = Square(1)
        with self.assertRaises(AttributeError):
            obj.__y

    def test_valide_attributes_1(self):
        """ Trying to pass a string value to Square """
        with self.assertRaises(TypeError):
            obj = Square("2", 2, 2, 2)
    ...
    def test_value_attributes_1(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
            obj = Square(0)

    def test_value_attributes_2(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
            obj = Square(1, -1)

    def test_value_attributes_3(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
            obj = Square(1, 1, -1)
